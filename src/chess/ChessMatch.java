...
public class ChessMatch {
    ...
    public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
        ...
        // promotion (must be done before check test)
        promoted = null;
    ...
    private Piece makeMove(Position source, Position target) {
        ...
        if (p instanceof King && target.getColumn() == source.getColumn() + 2) {
            Position rookPos = new Position(source.getRow(), source.getColumn() + 3);
            Position targetRookPos = new Position(source.getRow(), source.getColumn() + 1);

            ChessPiece rook = (ChessPiece) board.removePiece(rookPos);
        ...
        // queenside castle
        if (p instanceof King && target.getColumn() == source.getColumn() - 2) {
            Position rookPos = new Position(source.getRow(), source.getColumn() - 4);
            Position targetRookPos = new Position(source.getRow(), source.getColumn() - 1);
    ...
    private void undoMove(Position source, Position target, Piece capturedPiece) {
        ...
        if (p instanceof King && target.getColumn() == source.getColumn() + 2) {
            ...
            ChessPiece rook = (ChessPiece) board.removePiece(targetRookPos);
